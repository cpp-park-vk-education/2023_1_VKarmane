...
void MainWindow::turnVPN() {
    if (buttonCountryClicked) {
        ...
        //VPNClient client;
        if (!buttonClicked) {
            turnOnVPN(); // turnOnVPN(client);
        } else {
            turnOffVPN(); // turnOffVPN(client);
        }
    } else {
...
void MainWindow::turnOffVPN() { // void MainWindow::turnOffVPN(VPNClient& client)
...
void MainWindow::turnOnVPN() { // void MainWindow::turnOnVPN(VPNClient &client)
